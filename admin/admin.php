...
$articles_query = "SELECT a.*, u.username as author FROM articles a 
...
<main class="container dashboard">
    <div class="dashboard-header">
        ...
        <div class="admin-actions">
            <a href="create_article.php" class="btn-primary">➕ Buat Postingan Baru</a>
        </div>
    </div>
            ...
            <table>
                ...
                <tbody>
                    <?php while ($article = $articles_result->fetch_assoc()): ?>
                        <?php $count = getCommentCount($article['id']); ?>
                        <tr>
                            <td><?= $article['id'] ?></td>
